...
function Login() {
    ...
    return (
        <Container fluid>
            <div className="login_input_all">
                {/* 구름이미지 */}
                <div class="login_cloud_img">
                ...
                {/* 회원가입입력란 */}
                <div>
                    <div className="login_insert_input">
                    <Form.Control size="lg" type="text" placeholder="아이디(이메일)을 입력해주세요"/>
                    <Form.Control size="lg" type="password" placeholder="비밀번호를 입력해주세요"/>
                    </div>
                    <Row className="login_all_button d-flex justify-content-around">
                        <Col xs={12} sm={6}>
                            <button>로그인</button>
                        </Col>
                        <Col xm={12}>
